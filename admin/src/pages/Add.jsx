                ...
                <form action="" onSubmit={handleAddProduct} className='w-[100%] md:w-[90%] h-[100%] mt-[70px] flex flex-col gap-[30px] py-[60px] px-[30px] md:px-[60px]'>
                    ...
                    <div className='w-[80%] flex items-center gap-[10px] flex-wrap'>
                        ...
                        <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'>
                            ...
                            <select className='bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px]' onChange={(e) => setCategory(e.target.value)}>
                        ...
                        <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'>
                            ...
                            <select className='bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px]' onChange={(e) => setSubCategory(e.target.value)}>
                    ...
                    <button className='w-[140px] px-[20px] py-[20px] rounded-xl bg-[#65d8f7] flex items-center justify-center gap-[10px] text-black active:bg-slate-700 active:text-white active:border-[2px] border-white cursor-pointer'>{loading?<Loading/>: "ADD PRODUCT"}</button>
