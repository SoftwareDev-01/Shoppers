  ...
  return (
    <div className="w-full h-screen relative overflow-hidden font-sans text-white">
      ...
      <div className="relative z-30 flex flex-col items-center">
        ...
        >
          <h2 className="text-[30px] font-serif text-[#f5f1e8] mb-2">Welcome Back</h2>
          <p className="text-[#e0dcd0] text-[16px]">Log in to your royal cart</p>
        </motion.div>

        {/* Animated Login Form Container with staggered children */}
        <motion.div
          className="w-[90%] max-w-[480px] bg-[#ffffff0a] backdrop-blur-2xl border border-[#ffffff14] rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.35)] px-8 py-10 transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_0_30px_#c7a45e44]"
          initial="hidden"
          animate="visible"
